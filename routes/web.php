...
Route::get('/pay-cash/{orderId}', [PayNowController::class, 'createCashPayment'])->middleware('auth')->name('create.payment.cash');
...
Route::post('/login/{product_id}', [LoginController::class, 'login'])->name('login');
