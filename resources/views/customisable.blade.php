<link
    rel="stylesheet"
    href="{{ asset('template/outside/css/select2.min.css') }}"
/>
<form>
<div class="col-md-12">
...
<input style="margin: 10px 0px" type="text" name="field" placeholder="Enter field name..." class="form-control" />
</div>

<div class="col-md-6">

<input style="margin: 10px 0px" type="text" name="field" placeholder="Enter field value..." class="form-control" />
