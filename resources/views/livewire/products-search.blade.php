            ...
            <div class="container">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="isotope-product-filter col-auto">
                        @if ($products_search->count() > 0)
                        <button class="active" data-filter="*">all</button>
                        @else
                        <button class="active" data-filter="*">No products found according to your search!!!!!</button>
                        @endif
                    </div>
                        ...
                        <div class="product-item text-center">
                            ...
                            <div class="product-img">
                                ...
                                <div class="{{" action-btn fix"}}">
                                    ...
                                    <a href="#!" data-bs-toggle="modal"
                                        data-bs-target={{"#quickViewModal$product->id"}}><i class="{{" pe-7s-look
                                            product-btn-$product->id"}}"></i>Quick view</a>
                            ...
                            <div class="product-info text-left">
                                ...
                                <div class="price-ratting fix">
                                    <span class="price float-start"><span class="new">${{ $product->price
                                            }}</span></span>
